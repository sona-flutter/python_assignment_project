...
class MainFrame():
    def __init__(self, parent, main_frame, userData):
        ...
        self.root = tk.TK()
        self.root.grometry('1400x800')
        self.root.resizable(0,0)
        self.root.title("Font by Core2web")
        self.root.iconbitmap("./assets/images/core2web.png")
        self.login()
        
    def logIn(self):
        #(Create a farme to hold UI)
    ...
    #self.txt="WLCOME"
        self.txt="CORE2WEB"
        self.heading=tk.Label(self.lgn_frame,text=self.txt,font=('yu gothicui',25,"bold"),bg="#040405",gf='white',bd=5,relief=tk.FLAT)
        ...
        #(USERNAME)
        self.username_label=tk.Label(self.lgn_frame, text="Username", bg="#040405", fg="#f4e4d",font=("yu gothic ui", 13,,"bold"))
        self.username_label.place(x=550,y=300)
        
        self.username_entry=tk.Label(self.lgn_frame,highlightthickness=0,relief=tk.FlAT,bg="6b6a69",font("yu gothic ui",12,"bold"),insertbackground='#6b6a69')
        self.userData_entry.place(x=580,y=335,width=270)
